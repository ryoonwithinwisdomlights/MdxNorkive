---
title: Mdx Norkive(노션 컨텐츠 기반의 정적 MDX블로그)
slug: projects-Mdx-Norkive-노션-컨텐츠-기반의-정적-MDX블
summary: >-
  A type-safe knowledge archive platform that converts Notion content to MDX and
  deploys as a static Next.js 15 blog
pageCover: >-
  https://res.cloudinary.com/dyrdul1dd/image/upload/v1760935455/norkive-notion-images/png_1760935454922_RTFfODRfOD.webp?format=webp&quality=90
...
favorite: true
date: '2025-10-15'
last_edited_time: '2025-10-20T03:43:00.000Z'
lastEditedDate: 2025-10-20T03:43:00.000Z
draft: false
description: >-
  A type-safe knowledge archive platform that converts Notion content to MDX and
  deploys as a static Next.js 15 blog
...
> Notion 콘텐츠를 MDX로 변환하여 Next.js 15 기반 정적 블로그로 배포하는 타입 안전 지식 아카이브 플랫폼입니다. 반응형으로 웹과 모바일 둘다 지원합니다.
...
- [핵심 요약](https://github.com/ryoonwithinwisdomlights/MdxNorkive#-%ED%95%B5%EC%8B%AC-%EC%9A%94%EC%95%BD-executive-summary) ⭐
...
- [개인 기여 요약](https://github.com/ryoonwithinwisdomlights/MdxNorkive#-%EA%B0%9C%EC%9D%B8-%EA%B8%B0%EC%97%AC-%EC%9A%94%EC%95%BD) 👨‍💻
...
- ✅ <strong>성능 최적화</strong>:  TTFB 200ms이하, LCP 1.2s 이하 달성
...
![다운로드.svg](https://res.cloudinary.com/dyrdul1dd/image/upload/v1760935452/norkive-notion-images/svg_1760935451088_RTFfODRfOD.svg)
...
| ---------------------------------- | --------- | ----------- | ---------- |
| <strong>LCP</strong> (Largest Contentful Paint) | 1.2s      | under 2.5s  | ✅ 우수       |
| <strong>FID</strong> (First Input Delay)        | 12ms      | under 100ms | ✅ 우수       |
| <strong>CLS</strong> (Cumulative Layout Shift)  | 0.02      | under 0.1   | ✅ 우수       |
| <strong>FCP</strong> (First Contentful Paint)   | 0.8s      | under 1.8s  | ✅ 우수       |
| <strong>TTFB</strong> (Time to First Byte)      | 180ms     | under 600ms | ✅ 우수       |
...
- 🌐 Website: [https://github.com/ryoonwithinwisdomlights](https://github.com/ryoonwithinwisdomlights)
