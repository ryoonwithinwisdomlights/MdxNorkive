 ...
 * @param docsList - The list of docs
 * @returns
 */
const DateSortedDocs = ({ title, docsList }: BasicPageDivProps) => {
  ...
  const docs = useMemo(() => docsList[title] || [], [docsList, title]);
...
export default memo(DateSortedDocs);
