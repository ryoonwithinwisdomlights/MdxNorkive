...
import { compressImage, mapImgUrl } from "@/lib/data/utils";
...
const NotionPage = ({ record }) => {
  ...
  return (
    <div
      id="notion-article"
      className={`mx-auto dark:text-neutral-300 text-neutral-700 overflow-hidden w-full px-5 rounded-2xl  bg-norkive-light dark:bg-neutral-800`}
    >
      <NotionRenderer
