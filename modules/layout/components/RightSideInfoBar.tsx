...
const RightSideInfoBar = () => {
  return (
    <div
      className="hidden md:w-[300px]   h-screen md:fixed xl:block m-0
right-0 border-l bg-neutral-100 dark:bg-transparent border-neutral-200 dark:border-transparent 
 z-10  py-16   "
    >
