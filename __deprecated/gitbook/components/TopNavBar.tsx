...
import Collapse from "@/components/typescript/Collapse";
import { MenuBarMobile } from "./typescript/MenuBarMobile";
import LogoBar from "./typescript/LogoBar";
import DarkModeButton from "@/components/typescript/DarkModeButton";
import { MenuItemDrop } from "./typescript/MenuItemDrop";

const TopNavBar = () => {
  const { className, customNav, customMenu, locale } = useGlobal();
